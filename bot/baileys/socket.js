...
export const enviarArquivoLocal = async(c, tipo, id_chat, caminhoArquivo, legenda) =>{ 
    if(tipo == tiposMensagem.imagem){
        return await c.sendMessage(id_chat, {image: {url: caminhoArquivo}, caption: legenda})
    }
}
